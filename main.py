...
st.set_page_config(page_title="Sentiment Analysis System",page_icon="https://th.bing.com/th/id/OIP.vWfAgGePPL4xfsC3UYHmwgHaHa?rs=1&pid=ImgDetMain")
st.title("SENTIMENT ANALYSIS SYSTEM")
st.sidebar.image("https://calln.com/wp-content/uploads/2019/10/Sentiment-Analysis-Infographic-860x600-860x600.png")
choice=st.sidebar.selectbox("My Menu",("Home","Analyze Sentiment","Visualization","CSV File"))
if(choice=="Home"):
